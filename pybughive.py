...
# Remove pymongo and dotenv imports
# import pymongo
...
with open('/Users/jcmuchar/Documents/pybughive/dataset/pybughive_current.json', 'r', encoding='utf-8') as f:
    bughive_data = json.load(f)

WORKDIR = os.getcwd()

def find_project(repository_name):
    for project in bughive_data:
        if project['repository'] == repository_name:
            return project
    return None
